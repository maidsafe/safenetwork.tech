...
import TextSnippetContainer from './text_snippet_container'
import MediaSnippetContainer from './media_snippet_container'
import AssetDownloadContainer from '~components/asset_download/index'
  ...
  return (
    <section className="pressKit">
      <div className="pressKit__wrap">
        ...
        <TextSnippetContainer data={textSnippetData} />
        <MediaSnippetContainer
          interviewRequest={content.interviewRequest}
          mediaData={MediaSnippetData}
        />
        <AssetDownloadContainer
