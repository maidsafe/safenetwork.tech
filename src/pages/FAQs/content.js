  ...
  sections: [
    {
      ...
      items: [
        ...
        /*{
            ...
            answer: [
              '[Download the Safe Network App!](https://github.com/maidsafe/sn_app/releases/latest)'
            ]
          },*/
        {
    ...
    //   question: 'What do I need in order to browse the Safe Network?',
    //   answer: [
    //     '[Download the Safe Network App!](https://github.com/maidsafe/sn_app/releases)'
    //   ]
    // },
    // {
      ...
      items: [
        ...
        },
        {
          ...
          answer: [
            ...
            "[Watch a Video Explainer](https://www.youtube.com/watch?v=Jnvwv4z17b4&feature=youtu.be)",
          ],
        },
        {
    ...
    },
    {
      ...
      items: [
        ...
        {
          question:
            "What's the use of Safe Network Tokens in the Safe Network?",
          answer: [
        ...
        },
        {
          ...
          answer: [
            ...
            "MaidSafeCoin is listed on the Bitcoin blockchain and can be purchased on a number of exchanges and brokers including [Bittrex](https://global.bittrex.com/Market/Index?MarketName=BTC-MAID), [HitBTC](https://hitbtc.com/MAID-to-BTC) and [P2PB2B](https://p2pb2b.com/trade/MAID_BTC/).",
          ],
        },
        {
    ...
    },
    {
      ...
      items: [
        ...
        },
        {
          ...
          answer: [
            "All Safe Network and MaidSafe code is made available under [GPLv3](https://www.gnu.org/licenses/gpl.html), [BSD](https://www.linfo.org/bsdlicense.html) or [MIT](https://opensource.org/license/MIT) license.",
          ],
        },
      ],
    },
