      ...
      <div className="pkit-dwn pkit-lay">
        <div className="pkit-dwn-b">
          ...
          <div className="pkit-dwn-i">
            ...
            <p className="pkit-dwn-i-para">All SAFE Network logos and images by Dusan Sevarikaare made available via <a href="https://creativecommons.org/licenses/by-sa/4.0/">Creative Commons Attribution - ShareAlike 4.0</a></p>
